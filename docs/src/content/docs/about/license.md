...
Dublette is licensed under the **GNU Affero General Public License v3.0 or later** (AGPL-3.0-or-later).

This means you are free to use, modify, and distribute dublette, provided that:

- Any modified versions you distribute must also be licensed under AGPL-3.0-or-later
